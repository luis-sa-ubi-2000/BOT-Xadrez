...
while True:
    ...
    try:
        ...
        if not valid_mv:
            ...
            print('Invalid move by %d - %s. Player %d - %s (%s) wins. Game finished. ' % (idx_move % 2, nicks[idx_move % 2], 1 - (idx_move % 2), nicks[1 - (idx_move % 2)], colors[1 - (idx_move % 2)]))
            file_out.write('Invalid move by %d - %s. Player %d - %s (%s) wins. Game finished. ' % (idx_move % 2, nicks[idx_move % 2], 1 - (idx_move % 2), nicks[1 - (idx_move % 2)], colors[1 - (idx_move % 2)]))
            break
        ...
        if moves_without_eat >= moves_without_eat_to_draw:
            print('%d consecutives without eaten pieces. %s - %s Draw. Game finished. ' % (moves_without_eat, nicks[0], nicks[1]))
            file_out.write('%d consecutives without eaten pieces. %s - %s Draw. Game finished. ' % (moves_without_eat, nicks[0], nicks[1]))
            break
